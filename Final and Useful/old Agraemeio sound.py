...
def game(screen, background, colour,speed,pause):
...
def instructions(screen):
    ...
    while keep_going == True:
        ...
        pygame.display.flip()
    music.stop()
    return done_playing,colour,pause
...
def main():
    ...
    done_playing,colour,pause = instructions(screen)


    while done_playing == False:
        skip,score,pause = game(screen, background, colour, speed, pause)
        if skip == False:

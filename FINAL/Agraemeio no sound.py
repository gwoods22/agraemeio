...
def game(screen, background, colour,compliment,speed):
...
def instructions(screen):
    ...
    return done_playing,colour,compliment
...
def main():
    ...
    done_playing,colour,compliment = instructions(screen)


    while done_playing == False:
        skip,score = game(screen, background, colour, compliment, speed)
        if skip == False:
